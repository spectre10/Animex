    ...
    <div>
      {loading ? (
        ...
        Links.map((item,index) => {
          return (
            <div className="h-[60vh] w-screen relative" key={index}>
              <div className="h-full w-full absolute">
                {item.attributes.coverImage === null ? (
                  <img
                    className="object-cover filter h-full w-full"
              ...
              <img
                ...
                className="w-[195px] absolute -bottom-40 left-56 mb-5"
              ></img>
              <h1 className="text-white absolute bottom-28 left-[440px]">
